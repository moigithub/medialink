...
export const CATEG_FILTER_REM = "CATEG_FILTER-rem";
export const CATEG_FILTER_CLEAR="CATEG_FILTER_CLEAR";

export const MEDIA_TYPE_FILTER_ADD = "MEDIA_TYPE_FILTER-add";
export const MEDIA_TYPE_FILTER_REM = "MEDIA_TYPE_FILTER-rem";
export const MEDIA_TYPE_FILTER_CLEAR = "MEDIA_TYPE_FILTER_CLEAR";
